...
def draw_crosshair(self, context, use_focus):
    ...
    shader.bind()
    with cgl('depth_test', 'line_width', blend='ALPHA', depth_mask=False):
        for color, depth_test, line_width in ((color_visible, 'LESS_EQUAL', 1), (color_obscured, 'GREATER', 3)):
            cgl.depth_test = depth_test
            cgl.line_width = line_width
